        ...
        <section className="bg-white py-36 lg:py-44">
          <div className="mx-auto max-w-[1800px] px-10 md:px-20 lg:px-28">
            ...
            <div className="relative">
              <div className="absolute left-8 top-0 hidden h-full w-[1px] bg-charcoal/10 md:block" />
                ...
                {milestones.map((milestone, i) => (
                  ...
                  >
                    <div className="relative mb-4 md:mb-0">
                      ...
                      <div className="absolute left-[31px] top-3 hidden h-3 w-3 rounded-full border-2 border-brass bg-white md:block" />
                    </div>
                    <div className="rounded-sm border border-charcoal/5 bg-linen p-10">
            ...
            <div className="grid gap-20 lg:grid-cols-2 lg:gap-32">
              ...
              >
                ...
                <div className="relative mt-12 aspect-[3/4] overflow-hidden rounded-sm">
                  <Image
                    src="/images/WC18_Gilmore__24-314x470_12650884.jpg"
