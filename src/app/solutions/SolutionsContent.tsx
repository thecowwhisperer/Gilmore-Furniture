    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="relative flex min-h-[55vh] items-end overflow-hidden pb-28 pt-48">
          <Image
            src="/images/WC18_Gilmore__61_banner_bdc84ef8.jpg"
        ...
        {solutionCategories.map((category) => {
          const items = solutions.filter((s) => s.category === category);
          return (
            <section key={category} className="bg-linen py-36 lg:py-44">
              <div className="mx-auto max-w-[1440px] px-6 sm:px-10 md:px-20 lg:px-28">
                ...
                >
                  <div className="h-[1px] w-16 bg-brass" />
                  <h2 className="mt-6 font-serif text-[clamp(2.2rem,5vw,4rem)] font-light leading-[1] tracking-[-0.02em] text-charcoal">
                    {category}
                  </h2>
                </FadeIn>
                    ...
                    >
                      ...
                      >
                        <div className={i % 2 !== 0 ? "lg:[direction:ltr]" : ""}>
                          ...
                          <h3 className="font-serif text-[clamp(1.8rem,3.5vw,2.8rem)] font-light leading-[1.1] text-charcoal">
                            {solution.title}
                          </h3>
                        ...
                        <div className="mt-16">
                          ...
                          {solution.gallery.length >= 2 ? (
                            <div className="grid gap-5 md:grid-cols-3">
                              <div className="group relative aspect-[4/3] overflow-hidden rounded border border-charcoal/10 bg-white md:col-span-2 md:aspect-[3/2]">
                                <Image
                                  src={solution.gallery[0]}
                                  alt={solution.galleryAlts?.[0] ?? solution.title}
                                  fill
                              ...
                              <div className="group relative aspect-[4/3] overflow-hidden rounded border border-charcoal/10 bg-white md:aspect-auto">
                                <Image
                                  src={solution.gallery[1]}
                                  alt={solution.galleryAlts?.[1] ?? solution.title}
                                  fill
                                  className="object-contain p-4 transition-transform duration-500 group-hover:scale-105"
                          ...
                          {solution.gallery.length > 2 && (
                            <div className="mt-5 grid grid-cols-2 gap-5 md:grid-cols-3">
                              {solution.gallery.slice(2).map((img, gi) => (
                                <div
                                  key={img}
                                ...
                                >
                                  <Image
                                    src={img}
                                    alt={solution.galleryAlts?.[gi + 2] ?? solution.title}
                                    fill
                                    className="object-contain p-4 transition-transform duration-500 group-hover:scale-105"
