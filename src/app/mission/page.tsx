    ...
    <SmoothScroll>
      ...
      <main>
        ...
        <section className="relative flex min-h-[55vh] items-end overflow-hidden pb-28 pt-48">
          <Image
            src="/images/WC18_Gilmore__19-300x300_90270924.jpg"
        ...
        <section className="bg-white py-36 lg:py-44">
          <div className="mx-auto max-w-[1800px] px-10 md:px-20 lg:px-28">
            ...
            >
              <span className="mb-8 block text-[11px] font-semibold uppercase tracking-[0.4em] text-brass">
                Our Mission
              </span>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {values.map((value, i) => (
                <motion.div
                  ...
                  className="rounded-sm border border-charcoal/5 bg-white p-10 transition-all duration-500 hover:border-brass/20 hover:shadow-sm"
                >
                  <span className="font-serif text-3xl font-light text-brass/30">
                    {value.number}
                  </span>
          ...
          <div className="mx-auto max-w-[1800px] px-10 md:px-20 lg:px-28">
            ...
            >
              ...
              <div className="mt-12 flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
                <Link
                  href="/quote"
                  className="group relative overflow-hidden border border-brass px-12 py-5 text-[12px] uppercase tracking-[0.2em] text-brass transition-all duration-500 hover:text-white"
                >
                ...
                <Link
                  href="/careers"
                  className="border border-white/20 px-12 py-5 text-[12px] uppercase tracking-[0.2em] text-white/60 transition-all duration-300 hover:border-white/40 hover:text-white"
                >
                  Join Our Team
                </Link>
              </div>
