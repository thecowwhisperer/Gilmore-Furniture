      ...
      <main>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              {partners.map((partner, i) => (
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center rounded-sm border border-charcoal/5 bg-white p-8 transition-all duration-500 hover:border-brass/20 hover:shadow-sm"
                >
                  ...
                  <span className="mt-4 text-[11px] uppercase tracking-[0.1em] text-muted">
                    {partner.name}
                  </span>
                </motion.div>
              ))}
        ...
        <section className="bg-charcoal py-36 lg:py-44">
          <div className="mx-auto max-w-[1800px] px-10 md:px-20 lg:px-28">
            ...
            >
              <span className="mb-10 block text-[11px] font-semibold uppercase tracking-[0.4em] text-brass">
                Why They Choose Us
              </span>
