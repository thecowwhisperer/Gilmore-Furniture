...
const pillar = capabilityPillars.find((p) => p.slug === "woodworking")!;

const complexParts = [
  {
    title: "Compound Curves & 3D Profiles",
    description:
      "Multi-axis machining produces smooth, flowing surfaces that would be impossible with conventional 3-axis equipment. Ideal for organic furniture forms and ergonomic components.",
  },
  {
    title: "Clover-Style Components",
    description:
      "Complex multi-lobed shapes machined from solid wood with precision tolerances. These intricate parts showcase the full capability of our 5-axis CNC centers.",
  },
  {
    title: "Gun Stock Profiles",
    description:
      "Ergonomic contoured forms machined from hardwood blanks. Sub-millimeter precision across complex 3D geometry, ready for finishing or further assembly.",
  },
  {
    title: "Veneer-Wrapped Complex Shapes",
    description:
      "Cylinders, tapered forms, and sculpted bases wrapped with premium veneer or laminate. Seamless material application on even the most challenging geometries.",
  },
];

export default function WoodworkingContent() {
  return (
    <>
      <Navigation />
      <main id="main-content">
        ...
        <section className="border-t border-charcoal/10 bg-white py-36 lg:py-44">
          <div className="mx-auto max-w-[1440px] px-6 sm:px-10 md:px-20 lg:px-28">
            ...
            >
              ...
              <p className="mt-6 max-w-2xl text-[15px] leading-[1.9] text-muted">
                Our 5-axis CNC centers produce parts that go far beyond flat
                profiles. These capabilities allow us to machine intricate 3D
                forms from solid wood, composites, and polymers — parts that
                showcase genuine technical differentiation.
              </p>
            </FadeIn>

            <div className="grid gap-8 sm:grid-cols-2">
              {complexParts.map((part, i) => (
                <FadeIn
                  key={part.title}
                  initial={{ opacity: 0, y: 40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 0.1 * i }}
                  className="rounded-sm border border-charcoal/8 bg-linen/50 p-8 sm:p-10"
                >
                  <span className="mb-4 block font-serif text-3xl font-light text-brass/30">
                    {String(i + 1).padStart(2, "0")}
                  </span>
            ...
            <FadeIn
              ...
              className="mt-12 rounded-sm border border-brass/20 bg-brass/5 p-8 text-center"
            >
              <p className="text-[14px] leading-[1.8] text-muted">
                <span className="font-medium text-charcoal">
                  Have a complex part?
                </span>{" "}
                Send us your CAD files or drawings and we&apos;ll evaluate
                feasibility and provide a quote — from single prototype to
                production volumes.
              </p>
            </FadeIn>
          </div>
        ...
        {/* What We Produce */}
        <section className="border-t border-charcoal/10 bg-linen py-36 lg:py-44">
          <div className="mx-auto max-w-[1440px] px-6 sm:px-10 md:px-20 lg:px-28">
            <FadeIn
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {pillar.products.items.map((item) => (
                <FadeIn
                  ...
                  className="flex items-start gap-4 rounded-sm border border-charcoal/8 bg-white p-6"
                >
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {pillar.equipmentHighlights.map((item, i) => (
                <FadeIn
                  ...
                  className="border border-charcoal/8 bg-linen/50 p-8 text-center"
                >
          ...
          <div className="mx-auto max-w-[1440px] px-6 sm:px-10 md:px-20 lg:px-28">
            ...
            >
              ...
              <p className="mx-auto mt-8 max-w-2xl text-[15px] leading-[1.9] text-white/70">
                ...
                how our woodworking capabilities align with your requirements.
              </p>
